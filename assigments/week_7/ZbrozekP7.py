...
# Purpose:Define a class to keep track of a point in space. 
...
def header():
    print("Enter your City and State to find out if you are closer to Albany or Albuquerque\n  ")
...
def get_location():
    ...
    userLocation.city = input("Please enter a city name: ").title()
    userLocation.state = input("Please enter a state name: ").title()
    return userLocation
